...
exports.notifications = exports.menu = exports.schedule = exports.calendar = exports.news = exports.classmates = exports.children = exports.user = void 0;
const data = {
...
const classmates = (child) => data[child.id].classmates;
exports.classmates = classmates;
const news = (child) => data[child.id].news;
exports.news = news;
const calendar = (child) => data[child.id].calendar;
exports.calendar = calendar;
const schedule = (child) => data[child.id].schedule;
exports.schedule = schedule;
const menu = (child) => data[child.id].menu;
exports.menu = menu;
const notifications = (child) => data[child.id].notifications;
