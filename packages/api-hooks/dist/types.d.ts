import { Api, Child, User, CalendarItem, Classmate, MenuItem, NewsItem, Notification, ScheduleItem } from '@skolplattformen/embedded-api';
...
export declare type EntityStatus = 'pending' | 'loading' | 'loaded' | 'error';
...
export declare type EntityActionType = 'GET_FROM_API' | 'RESULT_FROM_API' | 'API_ERROR' | 'GET_FROM_CACHE' | 'RESULT_FROM_CACHE' | 'STORE_IN_CACHE' | 'CLEAR';
export declare type EntityName = 'USER' | 'CHILDREN' | 'CALENDAR' | 'CLASSMATES' | 'MENU' | 'NEWS' | 'NEWS_DETAILS' | 'NOTIFICATIONS' | 'SCHEDULE' | 'ALL';
...
export declare type EntityReducer<T> = Reducer<EntityMap<T>, EntityAction<T>>;
